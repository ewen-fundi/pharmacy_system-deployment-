...
<body>
    <div class="container">
        ...
        <?php if (isset($_GET['error']) && $_GET['error'] === 'linked'): ?>
            <div class="alert alert-error">❌ Cannot delete customer — they have linked orders or prescriptions.</div>
        <?php endif; ?>

        <a class="btn btn-add" href="add_customer.php">➕ Add Customer</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-edit" href="edit_customer.php?id=<?= $row['customer_id'] ?>">✏ Edit</a>
                    <a class="btn btn-delete" href="delete_customer.php?id=<?= $row['customer_id'] ?>" onclick="return confirm('Are you sure you want to delete this customer?')">🗑 Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
